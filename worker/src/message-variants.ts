...
export const MESSAGE_TEMPLATES: MessageTemplate[] = [
    // 1. CLINICS / MEDICAL
    {
        businessType: 'clinic',
        variants: [
            `Hi, I came across {name} on Google Maps. I noticed patients don’t have a simple contact page to WhatsApp you directly.\n\nI help clinics set up a small contact page so inquiries don’t get missed.\n\nCan I show you a quick example?`,
    ...
    // 3. LAW FIRMS / LEGAL
    {
        businessType: 'law',
        variants: [
            `Hi, I came across {name} on Google Maps. I noticed potential clients don’t have a simple contact page to WhatsApp you directly.\n\nI help law firms set this up so inquiries don’t get missed.\n\nCan I show you a quick example?`,
    ...
    // 4. SCHOOLS / TRAINING CENTERS
    {
        businessType: 'school',
        variants: [
            `Hi, I came across {name} on Google Maps. I noticed prospective students don’t have a simple contact page to WhatsApp you directly.\n\nI help schools set this up so inquiries don’t get missed.\n\nCan I show you a quick example?`,
    ...
    // 5. REAL ESTATE AGENTS
    {
        ...
        variants: [
            `Hi, I came across {name} on Google Maps. I noticed buyers don’t have a simple contact page to WhatsApp you directly.\n\nI help agents set this up so inquiries don’t get missed.\n\nCan I show you a quick example?`,
    ...
    // 6. RESTAURANTS
    {
        ...
        variants: [
            `Hi, I came across {name} on Google Maps. I noticed customers don’t have a simple contact page to WhatsApp you directly.\n\nI help restaurants set this up so inquiries don’t get missed.\n\nCan I show you a quick example?`,
    ...
    // 8. SALONS & BARBERSHOPS
    {
        businessType: 'salon',
        variants: [
            `Hi, I came across {name} on Google Maps. I noticed clients don’t have a simple contact page to WhatsApp you directly.\n\nI help salons set this up so inquiries don’t get missed.\n\nCan I show you a quick example?`,
    ...
    // 9. GYMS & FITNESS
    {
        businessType: 'gym',
        variants: [
            `Hi, I came across {name} on Google Maps. I noticed people don’t have a simple contact page to WhatsApp you directly.\n\nI help gyms set this up so inquiries don’t get missed.\n\nCan I show you a quick example?`,
    ...
    // 13. HOTELS / LODGES
    {
        businessType: 'hotel',
        variants: [
            `Hi, I came across {name} on Google Maps. I noticed guests don’t have a simple contact page to WhatsApp you directly.\n\nI help lodges set this up so inquiries don’t get missed.\n\nCan I show you a quick example?`,
